...
LastEditTime: 2023-08-07 15:46:43
FilePath: \ArknightsResearch\read_character_data.py
'''
import json
import pandas as pd
from mypgsql import search_sql, pg_query,insert_char_keys
import mypgsql2

file_path = 'E:\OneDrive\Code\Github\ArknightsGameData\zh_CN\gamedata\excel\character_table.json'
...
# 获取干员char_key列表
char_keys_with_name = [{"char_key": char_key} for char_key in json_data if char_key.startswith("char_")]


# 查找未插入数据库的干员
op_not_in_db = search_sql(char_keys_with_name)
