...
def get_info(html):  # info
    ...
    try:
        ...
        join_time = html.xpath('//*[@id="mf-section-2"]/table/tbody/tr[2]/td'
                               )[0].text.strip('\n').replace('年', '-').replace(
                                   '月', '-').replace('日', '')
...
def get_attribute(html):  # attribute
    ...
    try:
        ...
        attack = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="攻击\n"]/tbody/tr[th="攻击\n"]/td[3]'
        )[0].text.strip('\n')
        defence = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="防御\n"]/tbody/tr[th="防御\n"]/td[3]'
        )[0].text.strip('\n')
        antimagic = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="法术抗性\n"]/tbody/tr[th="法术抗性\n"]/td[3]'
        )[0].text.strip('\n')
        redeploy = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="再部署时间\n"]/tbody/tr[th="初始部署费用\n"]/td[1]'
        )[0].text.strip('\n')
        cost = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="初始部署费用\n"]/tbody/tr[th="初始部署费用\n"]/td[2]'
        )[0].text.strip('\n')
        block = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="阻挡数\n"]/tbody/tr[th="阻挡数\n"]/td[1]'
        )[0].text.strip('\n')
        atk_interval = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="攻击间隔\n"]/tbody/tr[th="攻击间隔\n"]/td[2]'
        )[0].text.strip('\n')
        life_rely = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="生命上限\n"]/tbody/tr[th="生命上限\n"]/td[5]'
        )[0].text.strip('\n')
        attack_rely = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="攻击\n"]/tbody/tr[th="攻击\n"]/td[5]'
        )[0].text.strip('\n')
        defence_rely = html.xpath(
            '//*[@id="mw-content-text"]/div/table[tbody/tr/th="防御\n"]/tbody/tr[th="防御\n"]/td[5]'
        )[0].text.strip('\n')
    except (IndexError):
    ...
    if rely_flag == 1:
        ...
        return local_column, [
            deploy_pos, block, cost, life, attack, defence, antimagic,
            atk_interval, redeploy
        ]
    elif rely_flag == 0:
        ...
        return local_column, [
            deploy_pos, block, cost, life, attack, defence, antimagic,
            atk_interval, redeploy, life_rely, attack_rely, defence_rely
        ]
...
def get_potential(html):
    ...
    try:
        ptt.append(
            html.xpath(
                '//*[@id="mw-content-text"]/div/h2[span[@id="潜能提升"]]/following-sibling::table/tbody/tr[2]/td[1]'
            )[0].text.strip('\n'))
        ptt.append(
            html.xpath(
                '//*[@id="mw-content-text"]/div/h2[span[@id="潜能提升"]]/following-sibling::table/tbody/tr[2]/td[2]'
            )[0].text.strip('\n'))
        ptt.append(
            html.xpath(
                '//*[@id="mw-content-text"]/div/h2[span[@id="潜能提升"]]/following-sibling::table/tbody/tr[2]/td[3]'
            )[0].text.strip('\n'))
        ptt.append(
            html.xpath(
                '//*[@id="mw-content-text"]/div/h2[span[@id="潜能提升"]]/following-sibling::table/tbody/tr[2]/td[4]'
            )[0].text.strip('\n'))
        ptt.append(
            html.xpath(
                '//*[@id="mw-content-text"]/div/h2[span[@id="潜能提升"]]/following-sibling::table/tbody/tr[2]/td[5]'
            )[0].text.strip('\n'))
    except:
