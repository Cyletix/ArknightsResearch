...
LastEditTime: 2024-05-13 23:02:58
...
character_table_path = "D:\OneDrive\Code\Project\ArknightsResearch\ArknightsStoryParse\ArknightsGameData\zh_CN\gamedata\excel\character_table.json"
...
def get_char_keys_list():
    # 获取干员char_key列表
    char_keys_list = [
        {"char_key": char_key} for char_key in json_data if char_key.startswith("char_")
    ]
