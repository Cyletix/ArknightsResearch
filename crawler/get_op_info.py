...
def get_data(html):
    ...
    data_dict["干员"] = html.xpath('//*[@id="charname" or @class="charname"]/text()')[
        0
    ]  # 干员
    try:
        data_dict["稀有度"] = re.search(
            "\d", html.xpath('//div[@class="charstar"]/img/@src')[0].split("/")[-1]
        ).group()  # 稀有度
    ...
    try:
        ...
        data_dict["职业"] = html.xpath(
            '//div[@id="mw-normal-catlinks"]/ul/li/a/text()'
        )[1][:2]
    except:
    ...
    try:
        ...
        pass
    try:
        data_dict["英文"] = html.xpath('//*[@class="charname-en"]/text()')[0].replace(
            "\\", ""
        )  # 英文
    except:
        pass
    try:
        date_str = html.xpath(
            '//table[tbody/tr/th="上线时间\n"]/tbody/tr[2]/td/text()'
        )[0]
    except:
        pass
    try:
        data_dict["上线时间"] = datetime.strptime(
            date_str, "%Y年%m月%d日 %H:%M\n"
        ).strftime("%Y-%m-%d %H:%M:%S")
    except:
        pass
    try:
        data_dict["部署位"] = html.xpath('//div[@class="char-pos-text"]/a/text()')[
            0
        ]  # 部署位,近战/远程,新增词条
    except:
        pass
    ...
    # attribute
    data_dict["再部署时间"] = html.xpath(
        '//*[th="再部署时间\n" or th="初始部署费用\n"]/td[1]/text()'
    )[0].strip("\n|s")
    data_dict["初始部署费用"] = html.xpath(
        '//*[th="再部署时间\n" or th="初始部署费用\n"]/td[2]/text()'
    )[0].strip("\n|s")
    data_dict["阻挡数"] = html.xpath(
        '//*[th="阻挡数\n" or th="攻击间隔\n"]/td[1]/text()'
    )[0].strip("\n")
    data_dict["攻击间隔"] = html.xpath(
        '//*[th="阻挡数\n" or th="攻击间隔\n"]/td[2]/text()'
    )[0].strip("\n|s")

    data_dict["生命上限-精英0 1级"] = html.xpath(
        '//*[tbody/tr/th="生命上限\n"]/tbody/tr[2]/td[1]/text()'
    )[0].strip("\n")
    data_dict["生命上限-精英0 满级"] = html.xpath(
        '//*[tbody/tr/th="生命上限\n"]/tbody/tr[2]/td[2]/text()'
    )[0].strip("\n")
    data_dict["生命上限-精英1 满级"] = html.xpath(
        '//*[tbody/tr/th="生命上限\n"]/tbody/tr[2]/td[3]/text()'
    )[0].strip("\n")
    data_dict["生命上限-精英2 满级"] = html.xpath(
        '//*[tbody/tr/th="生命上限\n"]/tbody/tr[2]/td[4]/text()'
    )[0].strip("\n")
    data_dict["生命上限-信赖加成上限"] = html.xpath(
        '//*[tbody/tr/th="生命上限\n"]/tbody/tr[2]/td[5]/text()'
    )[0].strip("\n")

    data_dict["攻击-精英0 1级"] = html.xpath(
        '//*[tbody/tr/th="攻击\n"]/tbody/tr[3]/td[1]/text()'
    )[0].strip("\n")
    data_dict["攻击-精英0 满级"] = html.xpath(
        '//*[tbody/tr/th="攻击\n"]/tbody/tr[3]/td[2]/text()'
    )[0].strip("\n")
    data_dict["攻击-精英1 满级"] = html.xpath(
        '//*[tbody/tr/th="攻击\n"]/tbody/tr[3]/td[3]/text()'
    )[0].strip("\n")
    data_dict["攻击-精英2 满级"] = html.xpath(
        '//*[tbody/tr/th="攻击\n"]/tbody/tr[3]/td[4]/text()'
    )[0].strip("\n")
    data_dict["攻击-信赖加成上限"] = html.xpath(
        '//*[tbody/tr/th="攻击\n"]/tbody/tr[3]/td[5]/text()'
    )[0].strip("\n")

    data_dict["防御-精英0 1级"] = html.xpath(
        '//*[tbody/tr/th="防御\n"]/tbody/tr[4]/td[1]/text()'
    )[0].strip("\n")
    data_dict["防御-精英0 满级"] = html.xpath(
        '//*[tbody/tr/th="防御\n"]/tbody/tr[4]/td[2]/text()'
    )[0].strip("\n")
    data_dict["防御-精英1 满级"] = html.xpath(
        '//*[tbody/tr/th="防御\n"]/tbody/tr[4]/td[3]/text()'
    )[0].strip("\n")
    data_dict["防御-精英2 满级"] = html.xpath(
        '//*[tbody/tr/th="防御\n"]/tbody/tr[4]/td[4]/text()'
    )[0].strip("\n")
    data_dict["防御-信赖加成上限"] = html.xpath(
        '//*[tbody/tr/th="防御\n"]/tbody/tr[4]/td[5]/text()'
    )[0].strip("\n")

    data_dict["法术抗性-精英0 1级"] = html.xpath(
        '//*[tbody/tr/th="法术抗性\n"]/tbody/tr[5]/td[1]/text()'
    )[0].strip("\n")
    data_dict["法术抗性-精英0 满级"] = html.xpath(
        '//*[tbody/tr/th="法术抗性\n"]/tbody/tr[5]/td[2]/text()'
    )[0].strip("\n")
    data_dict["法术抗性-精英1 满级"] = html.xpath(
        '//*[tbody/tr/th="法术抗性\n"]/tbody/tr[5]/td[3]/text()'
    )[0].strip("\n")
    data_dict["法术抗性-精英2 满级"] = html.xpath(
        '//*[tbody/tr/th="法术抗性\n"]/tbody/tr[5]/td[4]/text()'
    )[0].strip("\n")
    data_dict["法术抗性-信赖加成上限"] = html.xpath(
        '//*[tbody/tr/th="法术抗性\n"]/tbody/tr[5]/td[5]/text()'
    )[0].strip("\n")
    ...
    get_skill(
        "技能1 技能名称",
        1,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能1（精英0开放）"]/following-sibling::table[1]/tbody/tr[1]/td[2]/big/text()',
    )
    get_skill(
        "技能1 回复类型",
        1,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能1（精英0开放）"]/following-sibling::table[1]/tbody/tr[1]/td[3]/span[1]/span/text()',
    )
    get_skill(
        "技能1 触发类型",
        1,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能1（精英0开放）"]/following-sibling::table[1]/tbody/tr[1]/td[3]/span[2]/span/text()',
    )
    get_skill(
        "技能1 LV7 初始",
        1,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能1（精英0开放）"]/following-sibling::table[1]/tbody/tr[9]/td[3]/text()',
    )
    get_skill(
        "技能1 LV7 消耗",
        1,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能1（精英0开放）"]/following-sibling::table[1]/tbody/tr[9]/td[4]/text()',
    )
    get_skill(
        "技能1 LV7 持续",
        1,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能1（精英0开放）"]/following-sibling::table[1]/tbody/tr[9]/td[5]/text()',
    )
    ...
    get_skill(
        "技能2 技能名称",
        2,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能2（精英1开放）"]/following-sibling::table[1]/tbody/tr[1]/td[2]/big/text()',
    )
    get_skill(
        "技能2 回复类型",
        2,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能2（精英1开放）"]/following-sibling::table[1]/tbody/tr[1]/td[3]/span[1]/span/text()',
    )
    get_skill(
        "技能2 触发类型",
        2,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能2（精英1开放）"]/following-sibling::table[1]/tbody/tr[1]/td[3]/span[2]/span/text()',
    )
    get_skill(
        "技能2 LV7 初始",
        2,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能2（精英1开放）"]/following-sibling::table[1]/tbody/tr[9]/td[3]/text()',
    )
    get_skill(
        "技能2 LV7 消耗",
        2,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能2（精英1开放）"]/following-sibling::table[1]/tbody/tr[9]/td[4]/text()',
    )
    get_skill(
        "技能2 LV7 持续",
        2,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能2（精英1开放）"]/following-sibling::table[1]/tbody/tr[9]/td[5]/text()',
    )
    ...
    get_skill(
        "技能3 技能名称",
        3,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能3（精英2开放）"]/following-sibling::table[1]/tbody/tr[1]/td[2]/big/text()',
    )
    get_skill(
        "技能3 回复类型",
        3,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能3（精英2开放）"]/following-sibling::table[1]/tbody/tr[1]/td[3]/span[1]/span/text()',
    )
    get_skill(
        "技能3 触发类型",
        3,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能3（精英2开放）"]/following-sibling::table[1]/tbody/tr[1]/td[3]/span[2]/span/text()',
    )
    get_skill(
        "技能3 LV7 初始",
        3,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能3（精英2开放）"]/following-sibling::table[1]/tbody/tr[9]/td[3]/text()',
    )
    get_skill(
        "技能3 LV7 消耗",
        3,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能3（精英2开放）"]/following-sibling::table[1]/tbody/tr[9]/td[4]/text()',
    )
    get_skill(
        "技能3 LV7 持续",
        3,
        '//*[@id="mw-content-text"]/div[1]/p[b/text()="技能3（精英2开放）"]/following-sibling::table[1]/tbody/tr[9]/td[5]/text()',
    )
    ...
    if codename == "断罪者":
        ...
        try:
            ...
            data_dict["潜能2"] = html.xpath(
                potential_uni_path.replace("{rp}", "td[1]")
            )[0].strip("\n")
            data_dict["潜能3"] = html.xpath(
                potential_uni_path.replace("{rp}", "td[2]")
            )[0].strip("\n")
            data_dict["潜能4"] = html.xpath(
                potential_uni_path.replace("{rp}", "td[3]")
            )[0].strip("\n")
            data_dict["潜能5"] = html.xpath(
                potential_uni_path.replace("{rp}", "td[4]")
            )[0].strip("\n")
            data_dict["潜能6"] = html.xpath(
                potential_uni_path.replace("{rp}", "td[5]")
            )[0].strip("\n")
        except:
            data_dict["潜能2"] = html.xpath(
                '//*[span[@id="潜能提升"]]/following-sibling::section/table/tbody/tr[th/text()="潜能2\n"]/td/text()'
            )[0]
            data_dict["潜能3"] = html.xpath(
                '//*[span[@id="潜能提升"]]/following-sibling::section/table/tbody/tr[th/text()="潜能3\n"]/td/text()'
            )[0]
            data_dict["潜能4"] = html.xpath(
                '//*[span[@id="潜能提升"]]/following-sibling::section/table/tbody/tr[th/text()="潜能4\n"]/td/text()'
            )[0]
            data_dict["潜能5"] = html.xpath(
                '//*[span[@id="潜能提升"]]/following-sibling::section/table/tbody/tr[th/text()="潜能5\n"]/td/text()'
            )[0]
            data_dict["潜能6"] = html.xpath(
                '//*[span[@id="潜能提升"]]/following-sibling::section/table/tbody/tr[th/text()="潜能6\n"]/td/text()'
            )[0]
    return data_dict
...
if __name__ == "__main__":
    # read character_list from file
    with open("character_list.docker", "r", encoding="utf-8") as file:
    ...
    for codename in codename_list:
        ...
        cache_flag = False  # debug选项,False=强制从网页爬取
        ...
        if cache_flag:  # 从网页爬取并保存为缓存
            ...
            html_cache.close()
            print(
                "{0}{1}网页爬取成功({2}/{3})".format(
                    codename,
                    prt_split,
                    codename_list.index(codename) + 1,
                    len(codename_list),
                )
            )
            time.sleep(5)
